            ...
            <div class="flex flex-wrap items-center px-5 xl:px-10">
                ...
                <div class="w-full px-4 lg:w-1/2">
                    <div class="grid grid-cols-2 text-center md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3">
                        ...
                        @else
                            <div
                                class="col-span-8 mt-2 mb-2 mr-5 flex flex-wrap items-center justify-center rounded-lg bg-sky-500 p-2 text-white">
                                <h3 class="-ml-2 text-md">Maaf, halaman ini belum memiliki kategori 😓</h3>
                            </div>
                        @endif
                    </div>
                </div>
